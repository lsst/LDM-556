...
\textbf{Specification:}
A Dataset shall be deletable from a Data Repository by an authorized person.
...
\textbf{Discussion:}
Some Data Repositories (e.g. Data Releases) may not have any thusly authorized users. This would also involve removing it from registries. Removing the repository might require database table modifications. (UseCases: LDF3, DRP29)
